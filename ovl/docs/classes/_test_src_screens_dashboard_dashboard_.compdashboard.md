[kaltag-kundenportal](../README.md) › [Globals](../globals.md) › ["test/src/screens/Dashboard/Dashboard"](../modules/_test_src_screens_dashboard_dashboard_.md) › [CompDashboard](_test_src_screens_dashboard_dashboard_.compdashboard.md)
...
- [constructor](_test_src_screens_dashboard_dashboard_.compdashboard.md#constructor)

### Properties

- [ATTRIBUTE_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#attribute_node)
- [CDATA_SECTION_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#cdata_section_node)
- [COMMENT_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#comment_node)
- [DOCUMENT_FRAGMENT_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_fragment_node)
- [DOCUMENT_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_node)
- [DOCUMENT_POSITION_CONTAINED_BY](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_contained_by)
- [DOCUMENT_POSITION_CONTAINS](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_contains)
- [DOCUMENT_POSITION_DISCONNECTED](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_disconnected)
- [DOCUMENT_POSITION_FOLLOWING](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_following)
- [DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_implementation_specific)
- [DOCUMENT_POSITION_PRECEDING](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_position_preceding)
- [DOCUMENT_TYPE_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#document_type_node)
- [ELEMENT_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#element_node)
- [ENTITY_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#entity_node)
- [ENTITY_REFERENCE_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#entity_reference_node)
- [NOTATION_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#notation_node)
- [PROCESSING_INSTRUCTION_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#processing_instruction_node)
- [TEXT_NODE](_test_src_screens_dashboard_dashboard_.compdashboard.md#text_node)
- [\_flushId](_test_src_screens_dashboard_dashboard_.compdashboard.md#_flushid)
- [\_id](_test_src_screens_dashboard_dashboard_.compdashboard.md#_id)
- [accessKey](_test_src_screens_dashboard_dashboard_.compdashboard.md#accesskey)
- [accessKeyLabel](_test_src_screens_dashboard_dashboard_.compdashboard.md#accesskeylabel)
- [actions](_test_src_screens_dashboard_dashboard_.compdashboard.md#actions)
- [animatedClass](_test_src_screens_dashboard_dashboard_.compdashboard.md#animatedclass)
- [assignedSlot](_test_src_screens_dashboard_dashboard_.compdashboard.md#assignedslot)
- [async](_test_src_screens_dashboard_dashboard_.compdashboard.md#async)
- [attributes](_test_src_screens_dashboard_dashboard_.compdashboard.md#attributes)
- [autocapitalize](_test_src_screens_dashboard_dashboard_.compdashboard.md#autocapitalize)
- [autofocus](_test_src_screens_dashboard_dashboard_.compdashboard.md#autofocus)
- [baseURI](_test_src_screens_dashboard_dashboard_.compdashboard.md#baseuri)
- [childElementCount](_test_src_screens_dashboard_dashboard_.compdashboard.md#childelementcount)
- [childNodes](_test_src_screens_dashboard_dashboard_.compdashboard.md#childnodes)
- [children](_test_src_screens_dashboard_dashboard_.compdashboard.md#children)
- [classList](_test_src_screens_dashboard_dashboard_.compdashboard.md#classlist)
- [className](_test_src_screens_dashboard_dashboard_.compdashboard.md#classname)
- [clientHeight](_test_src_screens_dashboard_dashboard_.compdashboard.md#clientheight)
- [clientLeft](_test_src_screens_dashboard_dashboard_.compdashboard.md#clientleft)
- [clientTop](_test_src_screens_dashboard_dashboard_.compdashboard.md#clienttop)
- [clientWidth](_test_src_screens_dashboard_dashboard_.compdashboard.md#clientwidth)
- [contentEditable](_test_src_screens_dashboard_dashboard_.compdashboard.md#contenteditable)
- [dataset](_test_src_screens_dashboard_dashboard_.compdashboard.md#dataset)
- [dir](_test_src_screens_dashboard_dashboard_.compdashboard.md#dir)
- [draggable](_test_src_screens_dashboard_dashboard_.compdashboard.md#draggable)
- [firstChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#firstchild)
- [firstElementChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#firstelementchild)
- [hidden](_test_src_screens_dashboard_dashboard_.compdashboard.md#hidden)
- [id](_test_src_screens_dashboard_dashboard_.compdashboard.md#id)
- [innerHTML](_test_src_screens_dashboard_dashboard_.compdashboard.md#innerhtml)
- [innerText](_test_src_screens_dashboard_dashboard_.compdashboard.md#innertext)
- [inputMode](_test_src_screens_dashboard_dashboard_.compdashboard.md#inputmode)
- [isConnected](_test_src_screens_dashboard_dashboard_.compdashboard.md#isconnected)
- [isContentEditable](_test_src_screens_dashboard_dashboard_.compdashboard.md#iscontenteditable)
- [lang](_test_src_screens_dashboard_dashboard_.compdashboard.md#lang)
- [lastChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#lastchild)
- [lastElementChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#lastelementchild)
- [localName](_test_src_screens_dashboard_dashboard_.compdashboard.md#localname)
- [name](_test_src_screens_dashboard_dashboard_.compdashboard.md#name)
- [namespaceURI](_test_src_screens_dashboard_dashboard_.compdashboard.md#namespaceuri)
- [nextElementSibling](_test_src_screens_dashboard_dashboard_.compdashboard.md#nextelementsibling)
- [nextSibling](_test_src_screens_dashboard_dashboard_.compdashboard.md#nextsibling)
- [nodeName](_test_src_screens_dashboard_dashboard_.compdashboard.md#nodename)
- [nodeType](_test_src_screens_dashboard_dashboard_.compdashboard.md#nodetype)
- [nodeValue](_test_src_screens_dashboard_dashboard_.compdashboard.md#nodevalue)
- [nonce](_test_src_screens_dashboard_dashboard_.compdashboard.md#optional-nonce)
- [offsetHeight](_test_src_screens_dashboard_dashboard_.compdashboard.md#offsetheight)
- [offsetLeft](_test_src_screens_dashboard_dashboard_.compdashboard.md#offsetleft)
- [offsetParent](_test_src_screens_dashboard_dashboard_.compdashboard.md#offsetparent)
- [offsetTop](_test_src_screens_dashboard_dashboard_.compdashboard.md#offsettop)
- [offsetWidth](_test_src_screens_dashboard_dashboard_.compdashboard.md#offsetwidth)
- [onabort](_test_src_screens_dashboard_dashboard_.compdashboard.md#onabort)
- [onanimationcancel](_test_src_screens_dashboard_dashboard_.compdashboard.md#onanimationcancel)
- [onanimationend](_test_src_screens_dashboard_dashboard_.compdashboard.md#onanimationend)
- [onanimationiteration](_test_src_screens_dashboard_dashboard_.compdashboard.md#onanimationiteration)
- [onanimationstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#onanimationstart)
- [onauxclick](_test_src_screens_dashboard_dashboard_.compdashboard.md#onauxclick)
- [onblur](_test_src_screens_dashboard_dashboard_.compdashboard.md#onblur)
- [oncancel](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncancel)
- [oncanplay](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncanplay)
- [oncanplaythrough](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncanplaythrough)
- [onchange](_test_src_screens_dashboard_dashboard_.compdashboard.md#onchange)
- [onclick](_test_src_screens_dashboard_dashboard_.compdashboard.md#onclick)
- [onclose](_test_src_screens_dashboard_dashboard_.compdashboard.md#onclose)
- [oncontextmenu](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncontextmenu)
- [oncopy](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncopy)
- [oncuechange](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncuechange)
- [oncut](_test_src_screens_dashboard_dashboard_.compdashboard.md#oncut)
- [ondblclick](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondblclick)
- [ondrag](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondrag)
- [ondragend](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragend)
- [ondragenter](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragenter)
- [ondragexit](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragexit)
- [ondragleave](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragleave)
- [ondragover](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragover)
- [ondragstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondragstart)
- [ondrop](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondrop)
- [ondurationchange](_test_src_screens_dashboard_dashboard_.compdashboard.md#ondurationchange)
- [onemptied](_test_src_screens_dashboard_dashboard_.compdashboard.md#onemptied)
- [onended](_test_src_screens_dashboard_dashboard_.compdashboard.md#onended)
- [onerror](_test_src_screens_dashboard_dashboard_.compdashboard.md#onerror)
- [onfocus](_test_src_screens_dashboard_dashboard_.compdashboard.md#onfocus)
- [onfullscreenchange](_test_src_screens_dashboard_dashboard_.compdashboard.md#onfullscreenchange)
- [onfullscreenerror](_test_src_screens_dashboard_dashboard_.compdashboard.md#onfullscreenerror)
- [ongotpointercapture](_test_src_screens_dashboard_dashboard_.compdashboard.md#ongotpointercapture)
- [oninput](_test_src_screens_dashboard_dashboard_.compdashboard.md#oninput)
- [oninvalid](_test_src_screens_dashboard_dashboard_.compdashboard.md#oninvalid)
- [onkeydown](_test_src_screens_dashboard_dashboard_.compdashboard.md#onkeydown)
- [onkeypress](_test_src_screens_dashboard_dashboard_.compdashboard.md#onkeypress)
- [onkeyup](_test_src_screens_dashboard_dashboard_.compdashboard.md#onkeyup)
- [onload](_test_src_screens_dashboard_dashboard_.compdashboard.md#onload)
- [onloadeddata](_test_src_screens_dashboard_dashboard_.compdashboard.md#onloadeddata)
- [onloadedmetadata](_test_src_screens_dashboard_dashboard_.compdashboard.md#onloadedmetadata)
- [onloadstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#onloadstart)
- [onlostpointercapture](_test_src_screens_dashboard_dashboard_.compdashboard.md#onlostpointercapture)
- [onmousedown](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmousedown)
- [onmouseenter](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmouseenter)
- [onmouseleave](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmouseleave)
- [onmousemove](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmousemove)
- [onmouseout](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmouseout)
- [onmouseover](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmouseover)
- [onmouseup](_test_src_screens_dashboard_dashboard_.compdashboard.md#onmouseup)
- [onpaste](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpaste)
- [onpause](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpause)
- [onplay](_test_src_screens_dashboard_dashboard_.compdashboard.md#onplay)
- [onplaying](_test_src_screens_dashboard_dashboard_.compdashboard.md#onplaying)
- [onpointercancel](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointercancel)
- [onpointerdown](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerdown)
- [onpointerenter](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerenter)
- [onpointerleave](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerleave)
- [onpointermove](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointermove)
- [onpointerout](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerout)
- [onpointerover](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerover)
- [onpointerup](_test_src_screens_dashboard_dashboard_.compdashboard.md#onpointerup)
- [onprogress](_test_src_screens_dashboard_dashboard_.compdashboard.md#onprogress)
- [onratechange](_test_src_screens_dashboard_dashboard_.compdashboard.md#onratechange)
- [onreset](_test_src_screens_dashboard_dashboard_.compdashboard.md#onreset)
- [onresize](_test_src_screens_dashboard_dashboard_.compdashboard.md#onresize)
- [onscroll](_test_src_screens_dashboard_dashboard_.compdashboard.md#onscroll)
- [onsecuritypolicyviolation](_test_src_screens_dashboard_dashboard_.compdashboard.md#onsecuritypolicyviolation)
- [onseeked](_test_src_screens_dashboard_dashboard_.compdashboard.md#onseeked)
- [onseeking](_test_src_screens_dashboard_dashboard_.compdashboard.md#onseeking)
- [onselect](_test_src_screens_dashboard_dashboard_.compdashboard.md#onselect)
- [onselectionchange](_test_src_screens_dashboard_dashboard_.compdashboard.md#onselectionchange)
- [onselectstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#onselectstart)
- [onstalled](_test_src_screens_dashboard_dashboard_.compdashboard.md#onstalled)
- [onsubmit](_test_src_screens_dashboard_dashboard_.compdashboard.md#onsubmit)
- [onsuspend](_test_src_screens_dashboard_dashboard_.compdashboard.md#onsuspend)
- [ontimeupdate](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontimeupdate)
- [ontoggle](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontoggle)
- [ontouchcancel](_test_src_screens_dashboard_dashboard_.compdashboard.md#optional-ontouchcancel)
- [ontouchend](_test_src_screens_dashboard_dashboard_.compdashboard.md#optional-ontouchend)
- [ontouchmove](_test_src_screens_dashboard_dashboard_.compdashboard.md#optional-ontouchmove)
- [ontouchstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#optional-ontouchstart)
- [ontransitioncancel](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontransitioncancel)
- [ontransitionend](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontransitionend)
- [ontransitionrun](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontransitionrun)
- [ontransitionstart](_test_src_screens_dashboard_dashboard_.compdashboard.md#ontransitionstart)
- [onvolumechange](_test_src_screens_dashboard_dashboard_.compdashboard.md#onvolumechange)
- [onwaiting](_test_src_screens_dashboard_dashboard_.compdashboard.md#onwaiting)
- [onwheel](_test_src_screens_dashboard_dashboard_.compdashboard.md#onwheel)
- [outerHTML](_test_src_screens_dashboard_dashboard_.compdashboard.md#outerhtml)
- [ownerDocument](_test_src_screens_dashboard_dashboard_.compdashboard.md#ownerdocument)
- [parentElement](_test_src_screens_dashboard_dashboard_.compdashboard.md#parentelement)
- [parentNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#parentnode)
- [prefix](_test_src_screens_dashboard_dashboard_.compdashboard.md#prefix)
- [previousElementSibling](_test_src_screens_dashboard_dashboard_.compdashboard.md#previouselementsibling)
- [previousSibling](_test_src_screens_dashboard_dashboard_.compdashboard.md#previoussibling)
- [screen](_test_src_screens_dashboard_dashboard_.compdashboard.md#screen)
- [scrollHeight](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollheight)
- [scrollLeft](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollleft)
- [scrollTop](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrolltop)
- [scrollWidth](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollwidth)
- [shadowRoot](_test_src_screens_dashboard_dashboard_.compdashboard.md#shadowroot)
- [slot](_test_src_screens_dashboard_dashboard_.compdashboard.md#slot)
- [spellcheck](_test_src_screens_dashboard_dashboard_.compdashboard.md#spellcheck)
- [state](_test_src_screens_dashboard_dashboard_.compdashboard.md#state)
- [style](_test_src_screens_dashboard_dashboard_.compdashboard.md#style)
- [tabIndex](_test_src_screens_dashboard_dashboard_.compdashboard.md#tabindex)
- [tagName](_test_src_screens_dashboard_dashboard_.compdashboard.md#tagname)
- [textContent](_test_src_screens_dashboard_dashboard_.compdashboard.md#textcontent)
- [title](_test_src_screens_dashboard_dashboard_.compdashboard.md#title)
- [trackedTree](_test_src_screens_dashboard_dashboard_.compdashboard.md#trackedtree)
- [translate](_test_src_screens_dashboard_dashboard_.compdashboard.md#translate)
- [\_counter](_test_src_screens_dashboard_dashboard_.compdashboard.md#static-_counter)

### Methods

- [addEventListener](_test_src_screens_dashboard_dashboard_.compdashboard.md#addeventlistener)
- [after](_test_src_screens_dashboard_dashboard_.compdashboard.md#after)
- [afterRender](_test_src_screens_dashboard_dashboard_.compdashboard.md#afterrender)
- [animate](_test_src_screens_dashboard_dashboard_.compdashboard.md#animate)
- [append](_test_src_screens_dashboard_dashboard_.compdashboard.md#append)
- [appendChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#appendchild)
- [attachShadow](_test_src_screens_dashboard_dashboard_.compdashboard.md#attachshadow)
- [before](_test_src_screens_dashboard_dashboard_.compdashboard.md#before)
- [blur](_test_src_screens_dashboard_dashboard_.compdashboard.md#blur)
- [click](_test_src_screens_dashboard_dashboard_.compdashboard.md#click)
- [cloneNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#clonenode)
- [closest](_test_src_screens_dashboard_dashboard_.compdashboard.md#closest)
- [compareDocumentPosition](_test_src_screens_dashboard_dashboard_.compdashboard.md#comparedocumentposition)
- [connectedCallback](_test_src_screens_dashboard_dashboard_.compdashboard.md#connectedcallback)
- [contains](_test_src_screens_dashboard_dashboard_.compdashboard.md#contains)
- [disconnectedCallback](_test_src_screens_dashboard_dashboard_.compdashboard.md#disconnectedcallback)
- [dispatchEvent](_test_src_screens_dashboard_dashboard_.compdashboard.md#dispatchevent)
- [doRender](_test_src_screens_dashboard_dashboard_.compdashboard.md#dorender)
- [focus](_test_src_screens_dashboard_dashboard_.compdashboard.md#focus)
- [getAnimations](_test_src_screens_dashboard_dashboard_.compdashboard.md#getanimations)
- [getAttribute](_test_src_screens_dashboard_dashboard_.compdashboard.md#getattribute)
- [getAttributeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#getattributens)
- [getAttributeNames](_test_src_screens_dashboard_dashboard_.compdashboard.md#getattributenames)
- [getAttributeNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#getattributenode)
- [getAttributeNodeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#getattributenodens)
- [getBoundingClientRect](_test_src_screens_dashboard_dashboard_.compdashboard.md#getboundingclientrect)
- [getClientRects](_test_src_screens_dashboard_dashboard_.compdashboard.md#getclientrects)
- [getElementsByClassName](_test_src_screens_dashboard_dashboard_.compdashboard.md#getelementsbyclassname)
- [getElementsByTagName](_test_src_screens_dashboard_dashboard_.compdashboard.md#getelementsbytagname)
- [getElementsByTagNameNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#getelementsbytagnamens)
- [getRootNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#getrootnode)
- [getUI](_test_src_screens_dashboard_dashboard_.compdashboard.md#getui)
- [getUI](_test_src_screens_dashboard_dashboard_.compdashboard.md#getUI)
- [handleAnimationEnd](_test_src_screens_dashboard_dashboard_.compdashboard.md#handleanimationend)
- [hasAttribute](_test_src_screens_dashboard_dashboard_.compdashboard.md#hasattribute)
- [hasAttributeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#hasattributens)
- [hasAttributes](_test_src_screens_dashboard_dashboard_.compdashboard.md#hasattributes)
- [hasChildNodes](_test_src_screens_dashboard_dashboard_.compdashboard.md#haschildnodes)
- [hasPointerCapture](_test_src_screens_dashboard_dashboard_.compdashboard.md#haspointercapture)
- [init](_test_src_screens_dashboard_dashboard_.compdashboard.md#init)
- [insertAdjacentElement](_test_src_screens_dashboard_dashboard_.compdashboard.md#insertadjacentelement)
- [insertAdjacentHTML](_test_src_screens_dashboard_dashboard_.compdashboard.md#insertadjacenthtml)
- [insertAdjacentText](_test_src_screens_dashboard_dashboard_.compdashboard.md#insertadjacenttext)
- [insertBefore](_test_src_screens_dashboard_dashboard_.compdashboard.md#insertbefore)
- [isDefaultNamespace](_test_src_screens_dashboard_dashboard_.compdashboard.md#isdefaultnamespace)
- [isEqualNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#isequalnode)
- [isSameNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#issamenode)
- [lookupNamespaceURI](_test_src_screens_dashboard_dashboard_.compdashboard.md#lookupnamespaceuri)
- [lookupPrefix](_test_src_screens_dashboard_dashboard_.compdashboard.md#lookupprefix)
- [matches](_test_src_screens_dashboard_dashboard_.compdashboard.md#matches)
- [msGetRegionContent](_test_src_screens_dashboard_dashboard_.compdashboard.md#msgetregioncontent)
- [normalize](_test_src_screens_dashboard_dashboard_.compdashboard.md#normalize)
- [onUpdate](_test_src_screens_dashboard_dashboard_.compdashboard.md#onupdate)
- [prepend](_test_src_screens_dashboard_dashboard_.compdashboard.md#prepend)
- [querySelector](_test_src_screens_dashboard_dashboard_.compdashboard.md#queryselector)
- [querySelectorAll](_test_src_screens_dashboard_dashboard_.compdashboard.md#queryselectorall)
- [releasePointerCapture](_test_src_screens_dashboard_dashboard_.compdashboard.md#releasepointercapture)
- [remove](_test_src_screens_dashboard_dashboard_.compdashboard.md#remove)
- [removeAttribute](_test_src_screens_dashboard_dashboard_.compdashboard.md#removeattribute)
- [removeAttributeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#removeattributens)
- [removeAttributeNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#removeattributenode)
- [removeChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#removechild)
- [removeEventListener](_test_src_screens_dashboard_dashboard_.compdashboard.md#removeeventlistener)
- [removePathsFromTracking](_test_src_screens_dashboard_dashboard_.compdashboard.md#removepathsfromtracking)
- [replaceChild](_test_src_screens_dashboard_dashboard_.compdashboard.md#replacechild)
- [replaceWith](_test_src_screens_dashboard_dashboard_.compdashboard.md#replacewith)
- [requestFullscreen](_test_src_screens_dashboard_dashboard_.compdashboard.md#requestfullscreen)
- [requestPointerLock](_test_src_screens_dashboard_dashboard_.compdashboard.md#requestpointerlock)
- [screenClosing](_test_src_screens_dashboard_dashboard_.compdashboard.md#screenclosing)
- [screenVisible](_test_src_screens_dashboard_dashboard_.compdashboard.md#screenvisible)
- [scroll](_test_src_screens_dashboard_dashboard_.compdashboard.md#scroll)
- [scrollBy](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollby)
- [scrollIntoView](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollintoview)
- [scrollTo](_test_src_screens_dashboard_dashboard_.compdashboard.md#scrollto)
- [setAttribute](_test_src_screens_dashboard_dashboard_.compdashboard.md#setattribute)
- [setAttributeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#setattributens)
- [setAttributeNode](_test_src_screens_dashboard_dashboard_.compdashboard.md#setattributenode)
- [setAttributeNodeNS](_test_src_screens_dashboard_dashboard_.compdashboard.md#setattributenodens)
- [setPointerCapture](_test_src_screens_dashboard_dashboard_.compdashboard.md#setpointercapture)
- [setUI](_test_src_screens_dashboard_dashboard_.compdashboard.md#setui)
- [toggleAttribute](_test_src_screens_dashboard_dashboard_.compdashboard.md#toggleattribute)
- [webkitMatchesSelector](_test_src_screens_dashboard_dashboard_.compdashboard.md#webkitmatchesselector)

## Constructors

### constructor

\+ **new CompDashboard**(): _[CompDashboard](_test_src_screens_dashboard_dashboard_.compdashboard.md)_
...
**Returns:** _[CompDashboard](_test_src_screens_dashboard_dashboard_.compdashboard.md)_
...
_Defined in [test/src/screens/Dashboard/Dashboard.ts:13](https://github.com/fopsdev/ovl/blob/f9b6194/test/src/screens/Dashboard/Dashboard.ts#L13)_
...
_Defined in [test/src/screens/Dashboard/Dashboard.ts:9](https://github.com/fopsdev/ovl/blob/f9b6194/test/src/screens/Dashboard/Dashboard.ts#L9)_
