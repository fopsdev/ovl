[kaltag-kundenportal](../README.md) › [Globals](../globals.md) › ["ovl/src/library/Dialog/Dialog"](../modules/_ovl_src_library_dialog_dialog_.md) › [OvlDialog](_ovl_src_library_dialog_dialog_.ovldialog.md)
...
- [constructor](_ovl_src_library_dialog_dialog_.ovldialog.md#constructor)

### Properties

- [ATTRIBUTE_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#attribute_node)
- [CDATA_SECTION_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#cdata_section_node)
- [COMMENT_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#comment_node)
- [DOCUMENT_FRAGMENT_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#document_fragment_node)
- [DOCUMENT_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#document_node)
- [DOCUMENT_POSITION_CONTAINED_BY](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_contained_by)
- [DOCUMENT_POSITION_CONTAINS](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_contains)
- [DOCUMENT_POSITION_DISCONNECTED](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_disconnected)
- [DOCUMENT_POSITION_FOLLOWING](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_following)
- [DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_implementation_specific)
- [DOCUMENT_POSITION_PRECEDING](_ovl_src_library_dialog_dialog_.ovldialog.md#document_position_preceding)
- [DOCUMENT_TYPE_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#document_type_node)
- [ELEMENT_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#element_node)
- [ENTITY_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#entity_node)
- [ENTITY_REFERENCE_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#entity_reference_node)
- [NOTATION_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#notation_node)
- [PROCESSING_INSTRUCTION_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#processing_instruction_node)
- [TEXT_NODE](_ovl_src_library_dialog_dialog_.ovldialog.md#text_node)
- [\_flushId](_ovl_src_library_dialog_dialog_.ovldialog.md#_flushid)
- [\_id](_ovl_src_library_dialog_dialog_.ovldialog.md#_id)
- [accessKey](_ovl_src_library_dialog_dialog_.ovldialog.md#accesskey)
- [accessKeyLabel](_ovl_src_library_dialog_dialog_.ovldialog.md#accesskeylabel)
- [actions](_ovl_src_library_dialog_dialog_.ovldialog.md#actions)
- [animatedClass](_ovl_src_library_dialog_dialog_.ovldialog.md#animatedclass)
- [assignedSlot](_ovl_src_library_dialog_dialog_.ovldialog.md#assignedslot)
- [async](_ovl_src_library_dialog_dialog_.ovldialog.md#async)
- [attributes](_ovl_src_library_dialog_dialog_.ovldialog.md#attributes)
- [autocapitalize](_ovl_src_library_dialog_dialog_.ovldialog.md#autocapitalize)
- [autofocus](_ovl_src_library_dialog_dialog_.ovldialog.md#autofocus)
- [baseURI](_ovl_src_library_dialog_dialog_.ovldialog.md#baseuri)
- [childElementCount](_ovl_src_library_dialog_dialog_.ovldialog.md#childelementcount)
- [childNodes](_ovl_src_library_dialog_dialog_.ovldialog.md#childnodes)
- [children](_ovl_src_library_dialog_dialog_.ovldialog.md#children)
- [classList](_ovl_src_library_dialog_dialog_.ovldialog.md#classlist)
- [className](_ovl_src_library_dialog_dialog_.ovldialog.md#classname)
- [clientHeight](_ovl_src_library_dialog_dialog_.ovldialog.md#clientheight)
- [clientLeft](_ovl_src_library_dialog_dialog_.ovldialog.md#clientleft)
- [clientTop](_ovl_src_library_dialog_dialog_.ovldialog.md#clienttop)
- [clientWidth](_ovl_src_library_dialog_dialog_.ovldialog.md#clientwidth)
- [contentEditable](_ovl_src_library_dialog_dialog_.ovldialog.md#contenteditable)
- [dataset](_ovl_src_library_dialog_dialog_.ovldialog.md#dataset)
- [dir](_ovl_src_library_dialog_dialog_.ovldialog.md#dir)
- [draggable](_ovl_src_library_dialog_dialog_.ovldialog.md#draggable)
- [firstChild](_ovl_src_library_dialog_dialog_.ovldialog.md#firstchild)
- [firstElementChild](_ovl_src_library_dialog_dialog_.ovldialog.md#firstelementchild)
- [focusSet](_ovl_src_library_dialog_dialog_.ovldialog.md#focusset)
- [hidden](_ovl_src_library_dialog_dialog_.ovldialog.md#hidden)
- [id](_ovl_src_library_dialog_dialog_.ovldialog.md#id)
- [innerHTML](_ovl_src_library_dialog_dialog_.ovldialog.md#innerhtml)
- [innerText](_ovl_src_library_dialog_dialog_.ovldialog.md#innertext)
- [inputMode](_ovl_src_library_dialog_dialog_.ovldialog.md#inputmode)
- [isConnected](_ovl_src_library_dialog_dialog_.ovldialog.md#isconnected)
- [isContentEditable](_ovl_src_library_dialog_dialog_.ovldialog.md#iscontenteditable)
- [lang](_ovl_src_library_dialog_dialog_.ovldialog.md#lang)
- [lastChild](_ovl_src_library_dialog_dialog_.ovldialog.md#lastchild)
- [lastElementChild](_ovl_src_library_dialog_dialog_.ovldialog.md#lastelementchild)
- [localName](_ovl_src_library_dialog_dialog_.ovldialog.md#localname)
- [name](_ovl_src_library_dialog_dialog_.ovldialog.md#name)
- [namespaceURI](_ovl_src_library_dialog_dialog_.ovldialog.md#namespaceuri)
- [nextElementSibling](_ovl_src_library_dialog_dialog_.ovldialog.md#nextelementsibling)
- [nextSibling](_ovl_src_library_dialog_dialog_.ovldialog.md#nextsibling)
- [nodeName](_ovl_src_library_dialog_dialog_.ovldialog.md#nodename)
- [nodeType](_ovl_src_library_dialog_dialog_.ovldialog.md#nodetype)
- [nodeValue](_ovl_src_library_dialog_dialog_.ovldialog.md#nodevalue)
- [nonce](_ovl_src_library_dialog_dialog_.ovldialog.md#optional-nonce)
- [offsetHeight](_ovl_src_library_dialog_dialog_.ovldialog.md#offsetheight)
- [offsetLeft](_ovl_src_library_dialog_dialog_.ovldialog.md#offsetleft)
- [offsetParent](_ovl_src_library_dialog_dialog_.ovldialog.md#offsetparent)
- [offsetTop](_ovl_src_library_dialog_dialog_.ovldialog.md#offsettop)
- [offsetWidth](_ovl_src_library_dialog_dialog_.ovldialog.md#offsetwidth)
- [onabort](_ovl_src_library_dialog_dialog_.ovldialog.md#onabort)
- [onanimationcancel](_ovl_src_library_dialog_dialog_.ovldialog.md#onanimationcancel)
- [onanimationend](_ovl_src_library_dialog_dialog_.ovldialog.md#onanimationend)
- [onanimationiteration](_ovl_src_library_dialog_dialog_.ovldialog.md#onanimationiteration)
- [onanimationstart](_ovl_src_library_dialog_dialog_.ovldialog.md#onanimationstart)
- [onauxclick](_ovl_src_library_dialog_dialog_.ovldialog.md#onauxclick)
- [onblur](_ovl_src_library_dialog_dialog_.ovldialog.md#onblur)
- [oncancel](_ovl_src_library_dialog_dialog_.ovldialog.md#oncancel)
- [oncanplay](_ovl_src_library_dialog_dialog_.ovldialog.md#oncanplay)
- [oncanplaythrough](_ovl_src_library_dialog_dialog_.ovldialog.md#oncanplaythrough)
- [onchange](_ovl_src_library_dialog_dialog_.ovldialog.md#onchange)
- [onclick](_ovl_src_library_dialog_dialog_.ovldialog.md#onclick)
- [onclose](_ovl_src_library_dialog_dialog_.ovldialog.md#onclose)
- [oncontextmenu](_ovl_src_library_dialog_dialog_.ovldialog.md#oncontextmenu)
- [oncopy](_ovl_src_library_dialog_dialog_.ovldialog.md#oncopy)
- [oncuechange](_ovl_src_library_dialog_dialog_.ovldialog.md#oncuechange)
- [oncut](_ovl_src_library_dialog_dialog_.ovldialog.md#oncut)
- [ondblclick](_ovl_src_library_dialog_dialog_.ovldialog.md#ondblclick)
- [ondrag](_ovl_src_library_dialog_dialog_.ovldialog.md#ondrag)
- [ondragend](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragend)
- [ondragenter](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragenter)
- [ondragexit](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragexit)
- [ondragleave](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragleave)
- [ondragover](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragover)
- [ondragstart](_ovl_src_library_dialog_dialog_.ovldialog.md#ondragstart)
- [ondrop](_ovl_src_library_dialog_dialog_.ovldialog.md#ondrop)
- [ondurationchange](_ovl_src_library_dialog_dialog_.ovldialog.md#ondurationchange)
- [onemptied](_ovl_src_library_dialog_dialog_.ovldialog.md#onemptied)
- [onended](_ovl_src_library_dialog_dialog_.ovldialog.md#onended)
- [onerror](_ovl_src_library_dialog_dialog_.ovldialog.md#onerror)
- [onfocus](_ovl_src_library_dialog_dialog_.ovldialog.md#onfocus)
- [onfullscreenchange](_ovl_src_library_dialog_dialog_.ovldialog.md#onfullscreenchange)
- [onfullscreenerror](_ovl_src_library_dialog_dialog_.ovldialog.md#onfullscreenerror)
- [ongotpointercapture](_ovl_src_library_dialog_dialog_.ovldialog.md#ongotpointercapture)
- [oninput](_ovl_src_library_dialog_dialog_.ovldialog.md#oninput)
- [oninvalid](_ovl_src_library_dialog_dialog_.ovldialog.md#oninvalid)
- [onkeydown](_ovl_src_library_dialog_dialog_.ovldialog.md#onkeydown)
- [onkeypress](_ovl_src_library_dialog_dialog_.ovldialog.md#onkeypress)
- [onkeyup](_ovl_src_library_dialog_dialog_.ovldialog.md#onkeyup)
- [onload](_ovl_src_library_dialog_dialog_.ovldialog.md#onload)
- [onloadeddata](_ovl_src_library_dialog_dialog_.ovldialog.md#onloadeddata)
- [onloadedmetadata](_ovl_src_library_dialog_dialog_.ovldialog.md#onloadedmetadata)
- [onloadstart](_ovl_src_library_dialog_dialog_.ovldialog.md#onloadstart)
- [onlostpointercapture](_ovl_src_library_dialog_dialog_.ovldialog.md#onlostpointercapture)
- [onmousedown](_ovl_src_library_dialog_dialog_.ovldialog.md#onmousedown)
- [onmouseenter](_ovl_src_library_dialog_dialog_.ovldialog.md#onmouseenter)
- [onmouseleave](_ovl_src_library_dialog_dialog_.ovldialog.md#onmouseleave)
- [onmousemove](_ovl_src_library_dialog_dialog_.ovldialog.md#onmousemove)
- [onmouseout](_ovl_src_library_dialog_dialog_.ovldialog.md#onmouseout)
- [onmouseover](_ovl_src_library_dialog_dialog_.ovldialog.md#onmouseover)
- [onmouseup](_ovl_src_library_dialog_dialog_.ovldialog.md#onmouseup)
- [onpaste](_ovl_src_library_dialog_dialog_.ovldialog.md#onpaste)
- [onpause](_ovl_src_library_dialog_dialog_.ovldialog.md#onpause)
- [onplay](_ovl_src_library_dialog_dialog_.ovldialog.md#onplay)
- [onplaying](_ovl_src_library_dialog_dialog_.ovldialog.md#onplaying)
- [onpointercancel](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointercancel)
- [onpointerdown](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerdown)
- [onpointerenter](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerenter)
- [onpointerleave](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerleave)
- [onpointermove](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointermove)
- [onpointerout](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerout)
- [onpointerover](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerover)
- [onpointerup](_ovl_src_library_dialog_dialog_.ovldialog.md#onpointerup)
- [onprogress](_ovl_src_library_dialog_dialog_.ovldialog.md#onprogress)
- [onratechange](_ovl_src_library_dialog_dialog_.ovldialog.md#onratechange)
- [onreset](_ovl_src_library_dialog_dialog_.ovldialog.md#onreset)
- [onresize](_ovl_src_library_dialog_dialog_.ovldialog.md#onresize)
- [onscroll](_ovl_src_library_dialog_dialog_.ovldialog.md#onscroll)
- [onsecuritypolicyviolation](_ovl_src_library_dialog_dialog_.ovldialog.md#onsecuritypolicyviolation)
- [onseeked](_ovl_src_library_dialog_dialog_.ovldialog.md#onseeked)
- [onseeking](_ovl_src_library_dialog_dialog_.ovldialog.md#onseeking)
- [onselect](_ovl_src_library_dialog_dialog_.ovldialog.md#onselect)
- [onselectionchange](_ovl_src_library_dialog_dialog_.ovldialog.md#onselectionchange)
- [onselectstart](_ovl_src_library_dialog_dialog_.ovldialog.md#onselectstart)
- [onstalled](_ovl_src_library_dialog_dialog_.ovldialog.md#onstalled)
- [onsubmit](_ovl_src_library_dialog_dialog_.ovldialog.md#onsubmit)
- [onsuspend](_ovl_src_library_dialog_dialog_.ovldialog.md#onsuspend)
- [ontimeupdate](_ovl_src_library_dialog_dialog_.ovldialog.md#ontimeupdate)
- [ontoggle](_ovl_src_library_dialog_dialog_.ovldialog.md#ontoggle)
- [ontouchcancel](_ovl_src_library_dialog_dialog_.ovldialog.md#optional-ontouchcancel)
- [ontouchend](_ovl_src_library_dialog_dialog_.ovldialog.md#optional-ontouchend)
- [ontouchmove](_ovl_src_library_dialog_dialog_.ovldialog.md#optional-ontouchmove)
- [ontouchstart](_ovl_src_library_dialog_dialog_.ovldialog.md#optional-ontouchstart)
- [ontransitioncancel](_ovl_src_library_dialog_dialog_.ovldialog.md#ontransitioncancel)
- [ontransitionend](_ovl_src_library_dialog_dialog_.ovldialog.md#ontransitionend)
- [ontransitionrun](_ovl_src_library_dialog_dialog_.ovldialog.md#ontransitionrun)
- [ontransitionstart](_ovl_src_library_dialog_dialog_.ovldialog.md#ontransitionstart)
- [onvolumechange](_ovl_src_library_dialog_dialog_.ovldialog.md#onvolumechange)
- [onwaiting](_ovl_src_library_dialog_dialog_.ovldialog.md#onwaiting)
- [onwheel](_ovl_src_library_dialog_dialog_.ovldialog.md#onwheel)
- [outerHTML](_ovl_src_library_dialog_dialog_.ovldialog.md#outerhtml)
- [ownerDocument](_ovl_src_library_dialog_dialog_.ovldialog.md#ownerdocument)
- [parentElement](_ovl_src_library_dialog_dialog_.ovldialog.md#parentelement)
- [parentNode](_ovl_src_library_dialog_dialog_.ovldialog.md#parentnode)
- [prefix](_ovl_src_library_dialog_dialog_.ovldialog.md#prefix)
- [previousElementSibling](_ovl_src_library_dialog_dialog_.ovldialog.md#previouselementsibling)
- [previousSibling](_ovl_src_library_dialog_dialog_.ovldialog.md#previoussibling)
- [props](_ovl_src_library_dialog_dialog_.ovldialog.md#props)
- [screen](_ovl_src_library_dialog_dialog_.ovldialog.md#screen)
- [scrollHeight](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollheight)
- [scrollLeft](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollleft)
- [scrollTop](_ovl_src_library_dialog_dialog_.ovldialog.md#scrolltop)
- [scrollWidth](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollwidth)
- [shadowRoot](_ovl_src_library_dialog_dialog_.ovldialog.md#shadowroot)
- [slot](_ovl_src_library_dialog_dialog_.ovldialog.md#slot)
- [spellcheck](_ovl_src_library_dialog_dialog_.ovldialog.md#spellcheck)
- [state](_ovl_src_library_dialog_dialog_.ovldialog.md#state)
- [style](_ovl_src_library_dialog_dialog_.ovldialog.md#style)
- [tabIndex](_ovl_src_library_dialog_dialog_.ovldialog.md#tabindex)
- [tagName](_ovl_src_library_dialog_dialog_.ovldialog.md#tagname)
- [textContent](_ovl_src_library_dialog_dialog_.ovldialog.md#textcontent)
- [title](_ovl_src_library_dialog_dialog_.ovldialog.md#title)
- [trackedTree](_ovl_src_library_dialog_dialog_.ovldialog.md#trackedtree)
- [translate](_ovl_src_library_dialog_dialog_.ovldialog.md#translate)
- [\_counter](_ovl_src_library_dialog_dialog_.ovldialog.md#static-_counter)

### Methods

- [addEventListener](_ovl_src_library_dialog_dialog_.ovldialog.md#addeventlistener)
- [after](_ovl_src_library_dialog_dialog_.ovldialog.md#after)
- [afterRender](_ovl_src_library_dialog_dialog_.ovldialog.md#afterrender)
- [animate](_ovl_src_library_dialog_dialog_.ovldialog.md#animate)
- [append](_ovl_src_library_dialog_dialog_.ovldialog.md#append)
- [appendChild](_ovl_src_library_dialog_dialog_.ovldialog.md#appendchild)
- [attachShadow](_ovl_src_library_dialog_dialog_.ovldialog.md#attachshadow)
- [before](_ovl_src_library_dialog_dialog_.ovldialog.md#before)
- [blur](_ovl_src_library_dialog_dialog_.ovldialog.md#blur)
- [click](_ovl_src_library_dialog_dialog_.ovldialog.md#click)
- [cloneNode](_ovl_src_library_dialog_dialog_.ovldialog.md#clonenode)
- [closest](_ovl_src_library_dialog_dialog_.ovldialog.md#closest)
- [compareDocumentPosition](_ovl_src_library_dialog_dialog_.ovldialog.md#comparedocumentposition)
- [connectedCallback](_ovl_src_library_dialog_dialog_.ovldialog.md#connectedcallback)
- [contains](_ovl_src_library_dialog_dialog_.ovldialog.md#contains)
- [disconnectedCallback](_ovl_src_library_dialog_dialog_.ovldialog.md#disconnectedcallback)
- [dispatchEvent](_ovl_src_library_dialog_dialog_.ovldialog.md#dispatchevent)
- [doRender](_ovl_src_library_dialog_dialog_.ovldialog.md#dorender)
- [focus](_ovl_src_library_dialog_dialog_.ovldialog.md#focus)
- [getAnimations](_ovl_src_library_dialog_dialog_.ovldialog.md#getanimations)
- [getAttribute](_ovl_src_library_dialog_dialog_.ovldialog.md#getattribute)
- [getAttributeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#getattributens)
- [getAttributeNames](_ovl_src_library_dialog_dialog_.ovldialog.md#getattributenames)
- [getAttributeNode](_ovl_src_library_dialog_dialog_.ovldialog.md#getattributenode)
- [getAttributeNodeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#getattributenodens)
- [getBoundingClientRect](_ovl_src_library_dialog_dialog_.ovldialog.md#getboundingclientrect)
- [getClientRects](_ovl_src_library_dialog_dialog_.ovldialog.md#getclientrects)
- [getElementsByClassName](_ovl_src_library_dialog_dialog_.ovldialog.md#getelementsbyclassname)
- [getElementsByTagName](_ovl_src_library_dialog_dialog_.ovldialog.md#getelementsbytagname)
- [getElementsByTagNameNS](_ovl_src_library_dialog_dialog_.ovldialog.md#getelementsbytagnamens)
- [getRootNode](_ovl_src_library_dialog_dialog_.ovldialog.md#getrootnode)
- [getUI](_ovl_src_library_dialog_dialog_.ovldialog.md#getui)
- [getUI](_ovl_src_library_dialog_dialog_.ovldialog.md#getUI)
- [handleAnimationEnd](_ovl_src_library_dialog_dialog_.ovldialog.md#handleanimationend)
- [handleCancelClick](_ovl_src_library_dialog_dialog_.ovldialog.md#handlecancelclick)
- [handleDefault](_ovl_src_library_dialog_dialog_.ovldialog.md#handledefault)
- [handleOkClick](_ovl_src_library_dialog_dialog_.ovldialog.md#handleokclick)
- [handleResult](_ovl_src_library_dialog_dialog_.ovldialog.md#handleresult)
- [hasAttribute](_ovl_src_library_dialog_dialog_.ovldialog.md#hasattribute)
- [hasAttributeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#hasattributens)
- [hasAttributes](_ovl_src_library_dialog_dialog_.ovldialog.md#hasattributes)
- [hasChildNodes](_ovl_src_library_dialog_dialog_.ovldialog.md#haschildnodes)
- [hasPointerCapture](_ovl_src_library_dialog_dialog_.ovldialog.md#haspointercapture)
- [init](_ovl_src_library_dialog_dialog_.ovldialog.md#init)
- [insertAdjacentElement](_ovl_src_library_dialog_dialog_.ovldialog.md#insertadjacentelement)
- [insertAdjacentHTML](_ovl_src_library_dialog_dialog_.ovldialog.md#insertadjacenthtml)
- [insertAdjacentText](_ovl_src_library_dialog_dialog_.ovldialog.md#insertadjacenttext)
- [insertBefore](_ovl_src_library_dialog_dialog_.ovldialog.md#insertbefore)
- [isDefaultNamespace](_ovl_src_library_dialog_dialog_.ovldialog.md#isdefaultnamespace)
- [isEqualNode](_ovl_src_library_dialog_dialog_.ovldialog.md#isequalnode)
- [isSameNode](_ovl_src_library_dialog_dialog_.ovldialog.md#issamenode)
- [keyHandler](_ovl_src_library_dialog_dialog_.ovldialog.md#keyhandler)
- [lookupNamespaceURI](_ovl_src_library_dialog_dialog_.ovldialog.md#lookupnamespaceuri)
- [lookupPrefix](_ovl_src_library_dialog_dialog_.ovldialog.md#lookupprefix)
- [matches](_ovl_src_library_dialog_dialog_.ovldialog.md#matches)
- [msGetRegionContent](_ovl_src_library_dialog_dialog_.ovldialog.md#msgetregioncontent)
- [normalize](_ovl_src_library_dialog_dialog_.ovldialog.md#normalize)
- [onUpdate](_ovl_src_library_dialog_dialog_.ovldialog.md#onupdate)
- [prepend](_ovl_src_library_dialog_dialog_.ovldialog.md#prepend)
- [querySelector](_ovl_src_library_dialog_dialog_.ovldialog.md#queryselector)
- [querySelectorAll](_ovl_src_library_dialog_dialog_.ovldialog.md#queryselectorall)
- [releasePointerCapture](_ovl_src_library_dialog_dialog_.ovldialog.md#releasepointercapture)
- [remove](_ovl_src_library_dialog_dialog_.ovldialog.md#remove)
- [removeAttribute](_ovl_src_library_dialog_dialog_.ovldialog.md#removeattribute)
- [removeAttributeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#removeattributens)
- [removeAttributeNode](_ovl_src_library_dialog_dialog_.ovldialog.md#removeattributenode)
- [removeChild](_ovl_src_library_dialog_dialog_.ovldialog.md#removechild)
- [removeEventListener](_ovl_src_library_dialog_dialog_.ovldialog.md#removeeventlistener)
- [removePathsFromTracking](_ovl_src_library_dialog_dialog_.ovldialog.md#removepathsfromtracking)
- [replaceChild](_ovl_src_library_dialog_dialog_.ovldialog.md#replacechild)
- [replaceWith](_ovl_src_library_dialog_dialog_.ovldialog.md#replacewith)
- [requestFullscreen](_ovl_src_library_dialog_dialog_.ovldialog.md#requestfullscreen)
- [requestPointerLock](_ovl_src_library_dialog_dialog_.ovldialog.md#requestpointerlock)
- [screenClosing](_ovl_src_library_dialog_dialog_.ovldialog.md#screenclosing)
- [screenVisible](_ovl_src_library_dialog_dialog_.ovldialog.md#screenvisible)
- [scroll](_ovl_src_library_dialog_dialog_.ovldialog.md#scroll)
- [scrollBy](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollby)
- [scrollIntoView](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollintoview)
- [scrollTo](_ovl_src_library_dialog_dialog_.ovldialog.md#scrollto)
- [setAttribute](_ovl_src_library_dialog_dialog_.ovldialog.md#setattribute)
- [setAttributeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#setattributens)
- [setAttributeNode](_ovl_src_library_dialog_dialog_.ovldialog.md#setattributenode)
- [setAttributeNodeNS](_ovl_src_library_dialog_dialog_.ovldialog.md#setattributenodens)
- [setPointerCapture](_ovl_src_library_dialog_dialog_.ovldialog.md#setpointercapture)
- [setUI](_ovl_src_library_dialog_dialog_.ovldialog.md#setui)
- [toggleAttribute](_ovl_src_library_dialog_dialog_.ovldialog.md#toggleattribute)
- [webkitMatchesSelector](_ovl_src_library_dialog_dialog_.ovldialog.md#webkitmatchesselector)

## Constructors

### constructor

\+ **new OvlDialog**(): _[OvlDialog](_ovl_src_library_dialog_dialog_.ovldialog.md)_
...
**Returns:** _[OvlDialog](_ovl_src_library_dialog_dialog_.ovldialog.md)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:34](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L34)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:32](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L32)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:184](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L184)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:199](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L199)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:203](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L203)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:105](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L105)_
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:36](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L36)_
...
▸ **handleCancelClick**(): _void_

_Defined in [ovl/src/library/Dialog/Dialog.ts:57](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L57)_
...
▸ **handleDefault**(`def`: [ResultType](../modules/_ovl_src_library_dialog_dialog_.md#resulttype)): _void_

_Defined in [ovl/src/library/Dialog/Dialog.ts:64](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L64)_

**Parameters:**

| Name  | Type                                                                   |
| ----- | ---------------------------------------------------------------------- |
| `def` | [ResultType](../modules/_ovl_src_library_dialog_dialog_.md#resulttype) |
...
▸ **handleOkClick**(): _void_

_Defined in [ovl/src/library/Dialog/Dialog.ts:50](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L50)_
...
▸ **handleResult**(`result`: [ResultType](../modules/_ovl_src_library_dialog_dialog_.md#resulttype)): _void_

_Defined in [ovl/src/library/Dialog/Dialog.ts:43](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L43)_

**Parameters:**

| Name     | Type                                                                   |
| -------- | ---------------------------------------------------------------------- |
| `result` | [ResultType](../modules/_ovl_src_library_dialog_dialog_.md#resulttype) |
...
_Defined in [ovl/src/library/Dialog/Dialog.ts:74](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L74)_
...
▸ **keyHandler**(`e`: KeyboardEvent): _void_

_Defined in [ovl/src/library/Dialog/Dialog.ts:78](https://github.com/fopsdev/ovl/blob/f9b6194/ovl/src/library/Dialog/Dialog.ts#L78)_
