[kaltag-kundenportal](../README.md) › [Globals](../globals.md) › ["ovl/src/library/OvlBaseElement"](../modules/_ovl_src_library_ovlbaseelement_.md) › [OvlBaseElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md)

# Class: OvlBaseElement

## Hierarchy

- [HTMLElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#static-htmlelement)

  ↳ **OvlBaseElement**

  ↳ [OvlSnack](_ovl_src_library_snack_snack_.ovlsnack.md)

  ↳ [OvlDialog](_ovl_src_library_dialog_dialog_.ovldialog.md)

  ↳ [TableRowControl](_ovl_src_library_table_rowcontrol_.tablerowcontrol.md)

  ↳ [TableRowWrapper](_ovl_src_library_table_rowwrapper_.tablerowwrapper.md)

  ↳ [TableNavControl](_ovl_src_library_table_navcontrol_.tablenavcontrol.md)

  ↳ [OvlOverlay](_ovl_src_library_overlay_overlay_.ovloverlay.md)

  ↳ [TableHeaderMenu](_ovl_src_library_table_headermenu_.tableheadermenu.md)

  ↳ [TableHeader](_ovl_src_library_table_table_.tableheader.md)

  ↳ [OvlOverlay2](_ovl_src_library_overlay2_overlay2_.ovloverlay2.md)

  ↳ [OvlListControl](_ovl_src_library_forms_controls_listcontrol_.ovllistcontrol.md)

  ↳ [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md)

  ↳ [OvlTextbox](_ovl_src_library_forms_controls_textbox_.ovltextbox.md)

  ↳ [OvlHitList](_ovl_src_library_forms_controls_parts_hitlist_.ovlhitlist.md)

  ↳ [OvlTextArea](_ovl_src_library_forms_controls_textarea_.ovltextarea.md)

  ↳ [OvlOption](_ovl_src_library_forms_controls_option_.ovloption.md)

  ↳ [OvlTime](_ovl_src_library_forms_controls_time_.ovltime.md)

  ↳ [OvlDate](_ovl_src_library_forms_controls_date_.ovldate.md)

  ↳ [TableRow](_ovl_src_library_table_row_.tablerow.md)

  ↳ [TableRowSaveCancel](_ovl_src_library_table_rowformsavecancel_.tablerowsavecancel.md)

  ↳ [OvlAudit](_test_src_screens_audit_audit_.ovlaudit.md)

  ↳ [OvlRefresh](_test_src_components_refresh_refresh_.ovlrefresh.md)

  ↳ [CompShellbar](_test_src_screens_shellbar_shellbar_.compshellbar.md)

  ↳ [CompTranslation](_test_src_screens_translation_translation_.comptranslation.md)

  ↳ [OvlIndicator](_test_src_components_indicator_indicator_.ovlindicator.md)

  ↳ [OvlBackButton](_test_src_components_backbutton_backbutton_.ovlbackbutton.md)

  ↳ [CompFileList](_test_src_components_filelist_filelist_.compfilelist.md)

  ↳ [CompDashboard](_test_src_screens_dashboard_dashboard_.compdashboard.md)

  ↳ [CompOrderOverview](_test_src_screens_order_orderoverview_.comporderoverview.md)

  ↳ [CompQuotationOverview](_test_src_screens_quotation_quotationoverview_.compquotationoverview.md)

  ↳ [CompInvoiceOverview](_test_src_screens_invoice_invoiceoverview_.compinvoiceoverview.md)

  ↳ [CompDPInvoiceOverview](_test_src_screens_invoice_dpinvoiceoverview_.compdpinvoiceoverview.md)

  ↳ [CompSummaryChart](_test_src_screens_dashboard_summarychart_summarychart_.compsummarychart.md)

  ↳ [CompOrderFeedback](_test_src_screens_order_orderfeedback_.comporderfeedback.md)

  ↳ [CompOrderDetailLayout](_test_src_screens_order_orderdetaillayout_.comporderdetaillayout.md)

  ↳ [CompOrderDetail](_test_src_screens_order_orderdetail_.comporderdetail.md)

  ↳ [CompOrderTimeLine](_test_src_screens_order_ordertimeline_.compordertimeline.md)

  ↳ [CompTableTesting](_test_src_screens_tabletesting_tabletesting_.comptabletesting.md)

  ↳ [CompMobileTimeEntry](_test_src_screens_mobiletimerecording_mobiletimerecording_.compmobiletimeentry.md)

## Index

### Constructors

- [constructor](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#constructor)

### Properties

- [ATTRIBUTE_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#attribute_node)
- [CDATA_SECTION_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#cdata_section_node)
- [COMMENT_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#comment_node)
- [DOCUMENT_FRAGMENT_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_fragment_node)
- [DOCUMENT_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_node)
- [DOCUMENT_POSITION_CONTAINED_BY](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_contained_by)
- [DOCUMENT_POSITION_CONTAINS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_contains)
- [DOCUMENT_POSITION_DISCONNECTED](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_disconnected)
- [DOCUMENT_POSITION_FOLLOWING](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_following)
- [DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_implementation_specific)
- [DOCUMENT_POSITION_PRECEDING](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_position_preceding)
- [DOCUMENT_TYPE_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#document_type_node)
- [ELEMENT_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#element_node)
- [ENTITY_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#entity_node)
- [ENTITY_REFERENCE_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#entity_reference_node)
- [NOTATION_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#notation_node)
- [PROCESSING_INSTRUCTION_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#processing_instruction_node)
- [TEXT_NODE](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#text_node)
- [\_flushId](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#_flushid)
- [\_id](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#_id)
- [accessKey](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#accesskey)
- [accessKeyLabel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#accesskeylabel)
- [actions](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#actions)
- [animatedClass](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#animatedclass)
- [assignedSlot](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#assignedslot)
- [async](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#async)
- [attributes](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#attributes)
- [autocapitalize](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#autocapitalize)
- [autofocus](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#autofocus)
- [baseURI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#baseuri)
- [childElementCount](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#childelementcount)
- [childNodes](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#childnodes)
- [children](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#children)
- [classList](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#classlist)
- [className](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#classname)
- [clientHeight](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#clientheight)
- [clientLeft](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#clientleft)
- [clientTop](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#clienttop)
- [clientWidth](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#clientwidth)
- [contentEditable](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#contenteditable)
- [dataset](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#dataset)
- [dir](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#dir)
- [draggable](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#draggable)
- [firstChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#firstchild)
- [firstElementChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#firstelementchild)
- [hidden](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#hidden)
- [id](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#id)
- [innerHTML](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#innerhtml)
- [innerText](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#innertext)
- [inputMode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#inputmode)
- [isConnected](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#isconnected)
- [isContentEditable](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#iscontenteditable)
- [lang](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#lang)
- [lastChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#lastchild)
- [lastElementChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#lastelementchild)
- [localName](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#localname)
- [name](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#name)
- [namespaceURI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#namespaceuri)
- [nextElementSibling](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#nextelementsibling)
- [nextSibling](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#nextsibling)
- [nodeName](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#nodename)
- [nodeType](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#nodetype)
- [nodeValue](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#nodevalue)
- [nonce](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#optional-nonce)
- [offsetHeight](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#offsetheight)
- [offsetLeft](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#offsetleft)
- [offsetParent](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#offsetparent)
- [offsetTop](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#offsettop)
- [offsetWidth](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#offsetwidth)
- [onabort](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onabort)
- [onanimationcancel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onanimationcancel)
- [onanimationend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onanimationend)
- [onanimationiteration](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onanimationiteration)
- [onanimationstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onanimationstart)
- [onauxclick](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onauxclick)
- [onblur](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onblur)
- [oncancel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncancel)
- [oncanplay](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncanplay)
- [oncanplaythrough](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncanplaythrough)
- [onchange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onchange)
- [onclick](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onclick)
- [onclose](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onclose)
- [oncontextmenu](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncontextmenu)
- [oncopy](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncopy)
- [oncuechange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncuechange)
- [oncut](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oncut)
- [ondblclick](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondblclick)
- [ondrag](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondrag)
- [ondragend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragend)
- [ondragenter](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragenter)
- [ondragexit](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragexit)
- [ondragleave](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragleave)
- [ondragover](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragover)
- [ondragstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondragstart)
- [ondrop](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondrop)
- [ondurationchange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ondurationchange)
- [onemptied](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onemptied)
- [onended](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onended)
- [onerror](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onerror)
- [onfocus](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onfocus)
- [onfullscreenchange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onfullscreenchange)
- [onfullscreenerror](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onfullscreenerror)
- [ongotpointercapture](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ongotpointercapture)
- [oninput](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oninput)
- [oninvalid](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#oninvalid)
- [onkeydown](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onkeydown)
- [onkeypress](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onkeypress)
- [onkeyup](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onkeyup)
- [onload](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onload)
- [onloadeddata](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onloadeddata)
- [onloadedmetadata](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onloadedmetadata)
- [onloadstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onloadstart)
- [onlostpointercapture](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onlostpointercapture)
- [onmousedown](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmousedown)
- [onmouseenter](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmouseenter)
- [onmouseleave](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmouseleave)
- [onmousemove](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmousemove)
- [onmouseout](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmouseout)
- [onmouseover](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmouseover)
- [onmouseup](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onmouseup)
- [onpaste](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpaste)
- [onpause](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpause)
- [onplay](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onplay)
- [onplaying](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onplaying)
- [onpointercancel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointercancel)
- [onpointerdown](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerdown)
- [onpointerenter](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerenter)
- [onpointerleave](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerleave)
- [onpointermove](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointermove)
- [onpointerout](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerout)
- [onpointerover](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerover)
- [onpointerup](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onpointerup)
- [onprogress](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onprogress)
- [onratechange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onratechange)
- [onreset](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onreset)
- [onresize](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onresize)
- [onscroll](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onscroll)
- [onsecuritypolicyviolation](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onsecuritypolicyviolation)
- [onseeked](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onseeked)
- [onseeking](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onseeking)
- [onselect](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onselect)
- [onselectionchange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onselectionchange)
- [onselectstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onselectstart)
- [onstalled](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onstalled)
- [onsubmit](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onsubmit)
- [onsuspend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onsuspend)
- [ontimeupdate](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontimeupdate)
- [ontoggle](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontoggle)
- [ontouchcancel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#optional-ontouchcancel)
- [ontouchend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#optional-ontouchend)
- [ontouchmove](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#optional-ontouchmove)
- [ontouchstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#optional-ontouchstart)
- [ontransitioncancel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontransitioncancel)
- [ontransitionend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontransitionend)
- [ontransitionrun](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontransitionrun)
- [ontransitionstart](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ontransitionstart)
- [onvolumechange](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onvolumechange)
- [onwaiting](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onwaiting)
- [onwheel](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onwheel)
- [outerHTML](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#outerhtml)
- [ownerDocument](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#ownerdocument)
- [parentElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#parentelement)
- [parentNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#parentnode)
- [prefix](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#prefix)
- [previousElementSibling](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#previouselementsibling)
- [previousSibling](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#previoussibling)
- [screen](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#screen)
- [scrollHeight](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollheight)
- [scrollLeft](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollleft)
- [scrollTop](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrolltop)
- [scrollWidth](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollwidth)
- [shadowRoot](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#shadowroot)
- [slot](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#slot)
- [spellcheck](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#spellcheck)
- [state](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#state)
- [style](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#style)
- [tabIndex](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#tabindex)
- [tagName](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#tagname)
- [textContent](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#textcontent)
- [title](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#title)
- [trackedTree](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#trackedtree)
- [translate](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#translate)
- [HTMLElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#static-htmlelement)
- [\_counter](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#static-_counter)

### Methods

- [addEventListener](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#addeventlistener)
- [after](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#after)
- [afterRender](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#afterrender)
- [animate](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#animate)
- [append](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#append)
- [appendChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#appendchild)
- [attachShadow](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#attachshadow)
- [before](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#before)
- [blur](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#blur)
- [click](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#click)
- [cloneNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#clonenode)
- [closest](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#closest)
- [compareDocumentPosition](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#comparedocumentposition)
- [connectedCallback](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#connectedcallback)
- [contains](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#contains)
- [disconnectedCallback](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#disconnectedcallback)
- [dispatchEvent](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#dispatchevent)
- [doRender](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#dorender)
- [focus](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#focus)
- [getAnimations](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getanimations)
- [getAttribute](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getattribute)
- [getAttributeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getattributens)
- [getAttributeNames](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getattributenames)
- [getAttributeNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getattributenode)
- [getAttributeNodeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getattributenodens)
- [getBoundingClientRect](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getboundingclientrect)
- [getClientRects](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getclientrects)
- [getElementsByClassName](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getelementsbyclassname)
- [getElementsByTagName](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getelementsbytagname)
- [getElementsByTagNameNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getelementsbytagnamens)
- [getRootNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getrootnode)
- [getUI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getui)
- [getUI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#getUI)
- [handleAnimationEnd](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#handleanimationend)
- [hasAttribute](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#hasattribute)
- [hasAttributeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#hasattributens)
- [hasAttributes](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#hasattributes)
- [hasChildNodes](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#haschildnodes)
- [hasPointerCapture](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#haspointercapture)
- [init](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#init)
- [insertAdjacentElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#insertadjacentelement)
- [insertAdjacentHTML](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#insertadjacenthtml)
- [insertAdjacentText](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#insertadjacenttext)
- [insertBefore](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#insertbefore)
- [isDefaultNamespace](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#isdefaultnamespace)
- [isEqualNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#isequalnode)
- [isSameNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#issamenode)
- [lookupNamespaceURI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#lookupnamespaceuri)
- [lookupPrefix](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#lookupprefix)
- [matches](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#matches)
- [msGetRegionContent](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#msgetregioncontent)
- [normalize](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#normalize)
- [onUpdate](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#onupdate)
- [prepend](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#prepend)
- [querySelector](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#queryselector)
- [querySelectorAll](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#queryselectorall)
- [releasePointerCapture](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#releasepointercapture)
- [remove](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#remove)
- [removeAttribute](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removeattribute)
- [removeAttributeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removeattributens)
- [removeAttributeNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removeattributenode)
- [removeChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removechild)
- [removeEventListener](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removeeventlistener)
- [removePathsFromTracking](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#removepathsfromtracking)
- [replaceChild](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#replacechild)
- [replaceWith](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#replacewith)
- [requestFullscreen](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#requestfullscreen)
- [requestPointerLock](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#requestpointerlock)
- [screenClosing](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#screenclosing)
- [screenVisible](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#screenvisible)
- [scroll](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scroll)
- [scrollBy](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollby)
- [scrollIntoView](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollintoview)
- [scrollTo](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#scrollto)
- [setAttribute](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setattribute)
- [setAttributeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setattributens)
- [setAttributeNode](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setattributenode)
- [setAttributeNodeNS](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setattributenodens)
- [setPointerCapture](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setpointercapture)
- [setUI](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#setui)
- [toggleAttribute](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#toggleattribute)
- [webkitMatchesSelector](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#webkitmatchesselector)

## Constructors

### constructor

\+ **new OvlBaseElement**(): _[OvlBaseElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md)_
...
**Returns:** _[OvlBaseElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md)_
...
▪ **HTMLElement**: _object_

Defined in ovl/node_modules/typescript/lib/lib.dom.d.ts:6761

#### Type declaration:

- **new \_\_type**(): _[HTMLElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#static-htmlelement)_

- **prototype**: _[HTMLElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#static-htmlelement)_
