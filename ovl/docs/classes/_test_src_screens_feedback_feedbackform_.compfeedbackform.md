[kaltag-kundenportal](../README.md) › [Globals](../globals.md) › ["test/src/screens/Feedback/FeedbackForm"](../modules/_test_src_screens_feedback_feedbackform_.md) › [CompFeedbackForm](_test_src_screens_feedback_feedbackform_.compfeedbackform.md)

# Class: CompFeedbackForm
...
- [constructor](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#constructor)

### Properties

- [ATTRIBUTE_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#attribute_node)
- [CDATA_SECTION_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#cdata_section_node)
- [COMMENT_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#comment_node)
- [DOCUMENT_FRAGMENT_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_fragment_node)
- [DOCUMENT_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_node)
- [DOCUMENT_POSITION_CONTAINED_BY](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_contained_by)
- [DOCUMENT_POSITION_CONTAINS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_contains)
- [DOCUMENT_POSITION_DISCONNECTED](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_disconnected)
- [DOCUMENT_POSITION_FOLLOWING](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_following)
- [DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_implementation_specific)
- [DOCUMENT_POSITION_PRECEDING](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_position_preceding)
- [DOCUMENT_TYPE_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#document_type_node)
- [ELEMENT_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#element_node)
- [ENTITY_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#entity_node)
- [ENTITY_REFERENCE_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#entity_reference_node)
- [NOTATION_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#notation_node)
- [PROCESSING_INSTRUCTION_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#processing_instruction_node)
- [TEXT_NODE](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#text_node)
- [\_flushId](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#_flushid)
- [\_id](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#_id)
- [accessKey](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#accesskey)
- [accessKeyLabel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#accesskeylabel)
- [actions](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#actions)
- [animatedClass](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#animatedclass)
- [assignedSlot](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#assignedslot)
- [async](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#async)
- [attributes](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#attributes)
- [autocapitalize](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#autocapitalize)
- [autofocus](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#autofocus)
- [baseURI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#baseuri)
- [changedFnName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#changedfnname)
- [childElementCount](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#childelementcount)
- [childNodes](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#childnodes)
- [children](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#children)
- [classList](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#classlist)
- [className](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#classname)
- [clientHeight](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#clientheight)
- [clientLeft](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#clientleft)
- [clientTop](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#clienttop)
- [clientWidth](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#clientwidth)
- [contentEditable](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#contenteditable)
- [dataset](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#dataset)
- [dir](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#dir)
- [draggable](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#draggable)
- [firstChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#firstchild)
- [firstElementChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#firstelementchild)
- [formFields](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#formfields)
- [formId](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#formid)
- [formState](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#formstate)
- [formType](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#formtype)
- [hidden](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#hidden)
- [id](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#id)
- [innerHTML](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#innerhtml)
- [innerText](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#innertext)
- [inputMode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#inputmode)
- [isConnected](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#isconnected)
- [isContentEditable](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#iscontenteditable)
- [lang](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#lang)
- [lastChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#lastchild)
- [lastElementChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#lastelementchild)
- [localName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#localname)
- [name](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#name)
- [namespace](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#namespace)
- [namespaceURI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#namespaceuri)
- [nextElementSibling](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#nextelementsibling)
- [nextSibling](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#nextsibling)
- [nodeName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#nodename)
- [nodeType](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#nodetype)
- [nodeValue](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#nodevalue)
- [nonce](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#optional-nonce)
- [offsetHeight](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#offsetheight)
- [offsetLeft](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#offsetleft)
- [offsetParent](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#offsetparent)
- [offsetTop](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#offsettop)
- [offsetWidth](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#offsetwidth)
- [onabort](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onabort)
- [onanimationcancel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onanimationcancel)
- [onanimationend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onanimationend)
- [onanimationiteration](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onanimationiteration)
- [onanimationstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onanimationstart)
- [onauxclick](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onauxclick)
- [onblur](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onblur)
- [oncancel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncancel)
- [oncanplay](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncanplay)
- [oncanplaythrough](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncanplaythrough)
- [onchange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onchange)
- [onclick](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onclick)
- [onclose](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onclose)
- [oncontextmenu](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncontextmenu)
- [oncopy](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncopy)
- [oncuechange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncuechange)
- [oncut](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oncut)
- [ondblclick](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondblclick)
- [ondrag](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondrag)
- [ondragend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragend)
- [ondragenter](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragenter)
- [ondragexit](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragexit)
- [ondragleave](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragleave)
- [ondragover](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragover)
- [ondragstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondragstart)
- [ondrop](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondrop)
- [ondurationchange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ondurationchange)
- [onemptied](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onemptied)
- [onended](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onended)
- [onerror](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onerror)
- [onfocus](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onfocus)
- [onfullscreenchange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onfullscreenchange)
- [onfullscreenerror](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onfullscreenerror)
- [ongotpointercapture](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ongotpointercapture)
- [oninput](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oninput)
- [oninvalid](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#oninvalid)
- [onkeydown](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onkeydown)
- [onkeypress](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onkeypress)
- [onkeyup](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onkeyup)
- [onload](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onload)
- [onloadeddata](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onloadeddata)
- [onloadedmetadata](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onloadedmetadata)
- [onloadstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onloadstart)
- [onlostpointercapture](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onlostpointercapture)
- [onmousedown](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmousedown)
- [onmouseenter](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmouseenter)
- [onmouseleave](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmouseleave)
- [onmousemove](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmousemove)
- [onmouseout](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmouseout)
- [onmouseover](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmouseover)
- [onmouseup](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onmouseup)
- [onpaste](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpaste)
- [onpause](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpause)
- [onplay](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onplay)
- [onplaying](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onplaying)
- [onpointercancel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointercancel)
- [onpointerdown](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerdown)
- [onpointerenter](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerenter)
- [onpointerleave](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerleave)
- [onpointermove](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointermove)
- [onpointerout](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerout)
- [onpointerover](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerover)
- [onpointerup](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onpointerup)
- [onprogress](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onprogress)
- [onratechange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onratechange)
- [onreset](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onreset)
- [onresize](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onresize)
- [onscroll](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onscroll)
- [onsecuritypolicyviolation](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onsecuritypolicyviolation)
- [onseeked](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onseeked)
- [onseeking](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onseeking)
- [onselect](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onselect)
- [onselectionchange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onselectionchange)
- [onselectstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onselectstart)
- [onstalled](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onstalled)
- [onsubmit](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onsubmit)
- [onsuspend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onsuspend)
- [ontimeupdate](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontimeupdate)
- [ontoggle](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontoggle)
- [ontouchcancel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#optional-ontouchcancel)
- [ontouchend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#optional-ontouchend)
- [ontouchmove](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#optional-ontouchmove)
- [ontouchstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#optional-ontouchstart)
- [ontransitioncancel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontransitioncancel)
- [ontransitionend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontransitionend)
- [ontransitionrun](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontransitionrun)
- [ontransitionstart](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ontransitionstart)
- [onvolumechange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onvolumechange)
- [onwaiting](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onwaiting)
- [onwheel](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onwheel)
- [outerHTML](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#outerhtml)
- [ownerDocument](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#ownerdocument)
- [parentElement](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#parentelement)
- [parentNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#parentnode)
- [prefix](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#prefix)
- [previousElementSibling](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#previouselementsibling)
- [previousSibling](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#previoussibling)
- [schema](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#schema)
- [screen](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#screen)
- [scrollHeight](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollheight)
- [scrollLeft](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollleft)
- [scrollTop](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrolltop)
- [scrollWidth](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollwidth)
- [shadowRoot](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#shadowroot)
- [slot](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#slot)
- [spellcheck](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#spellcheck)
- [state](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#state)
- [style](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#style)
- [tabIndex](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#tabindex)
- [tagName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#tagname)
- [textContent](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#textcontent)
- [title](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#title)
- [trackedTree](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#trackedtree)
- [translate](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#translate)
- [validationFnName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#validationfnname)
- [\_counter](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#static-_counter)

### Methods

- [addEventListener](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#addeventlistener)
- [after](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#after)
- [afterRender](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#afterrender)
- [animate](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#animate)
- [append](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#append)
- [appendChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#appendchild)
- [attachShadow](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#attachshadow)
- [before](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#before)
- [blur](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#blur)
- [click](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#click)
- [cloneNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#clonenode)
- [closest](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#closest)
- [compareDocumentPosition](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#comparedocumentposition)
- [connectedCallback](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#connectedcallback)
- [contains](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#contains)
- [disconnectedCallback](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#disconnectedcallback)
- [dispatchEvent](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#dispatchevent)
- [doRender](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#dorender)
- [focus](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#focus)
- [getAnimations](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getanimations)
- [getAttribute](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getattribute)
- [getAttributeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getattributens)
- [getAttributeNames](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getattributenames)
- [getAttributeNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getattributenode)
- [getAttributeNodeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getattributenodens)
- [getBoundingClientRect](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getboundingclientrect)
- [getClientRects](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getclientrects)
- [getElementsByClassName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getelementsbyclassname)
- [getElementsByTagName](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getelementsbytagname)
- [getElementsByTagNameNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getelementsbytagnamens)
- [getFormFieldId](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getformfieldid)
- [getRootNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getrootnode)
- [getUI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getui)
- [getUI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#getUI)
- [handleAnimationEnd](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#handleanimationend)
- [handleOvlChange](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#handleovlchange)
- [handleOvlFocusOut](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#handleovlfocusout)
- [hasAttribute](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#hasattribute)
- [hasAttributeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#hasattributens)
- [hasAttributes](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#hasattributes)
- [hasChildNodes](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#haschildnodes)
- [hasPointerCapture](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#haspointercapture)
- [init](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#init)
- [insertAdjacentElement](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#insertadjacentelement)
- [insertAdjacentHTML](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#insertadjacenthtml)
- [insertAdjacentText](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#insertadjacenttext)
- [insertBefore](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#insertbefore)
- [isDefaultNamespace](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#isdefaultnamespace)
- [isEqualNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#isequalnode)
- [isSameNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#issamenode)
- [lookupNamespaceURI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#lookupnamespaceuri)
- [lookupPrefix](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#lookupprefix)
- [matches](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#matches)
- [msGetRegionContent](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#msgetregioncontent)
- [normalize](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#normalize)
- [onUpdate](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#onupdate)
- [prepend](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#prepend)
- [querySelector](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#queryselector)
- [querySelectorAll](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#queryselectorall)
- [releasePointerCapture](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#releasepointercapture)
- [remove](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#remove)
- [removeAttribute](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removeattribute)
- [removeAttributeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removeattributens)
- [removeAttributeNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removeattributenode)
- [removeChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removechild)
- [removeEventListener](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removeeventlistener)
- [removePathsFromTracking](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#removepathsfromtracking)
- [replaceChild](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#replacechild)
- [replaceWith](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#replacewith)
- [requestFullscreen](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#requestfullscreen)
- [requestPointerLock](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#requestpointerlock)
- [screenClosing](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#screenclosing)
- [screenVisible](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#screenvisible)
- [scroll](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scroll)
- [scrollBy](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollby)
- [scrollIntoView](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollintoview)
- [scrollTo](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#scrollto)
- [setAttribute](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setattribute)
- [setAttributeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setattributens)
- [setAttributeNode](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setattributenode)
- [setAttributeNodeNS](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setattributenodens)
- [setPointerCapture](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setpointercapture)
- [setUI](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#setui)
- [toggleAttribute](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#toggleattribute)
- [webkitMatchesSelector](_test_src_screens_feedback_feedbackform_.compfeedbackform.md#webkitmatchesselector)

## Constructors

### constructor

\+ **new CompFeedbackForm**(): _[CompFeedbackForm](_test_src_screens_feedback_feedbackform_.compfeedbackform.md)_
...
**Returns:** _[CompFeedbackForm](_test_src_screens_feedback_feedbackform_.compfeedbackform.md)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[changedFnName](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#changedfnname)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[formFields](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#formfields)_

Defined in ovl/src/library/forms/OvlFormElement.ts:25

#### Type declaration:

- \[ **key**: _string_\]: [FormFields](../modules/_ovl_src_library_forms_ovlformelement_.md#formfields)
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[formId](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#formid)_
...
• **formState**: _[FormState](../modules/_ovl_src_library_forms_actions_.md#formstate)_

_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[formState](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#formstate)_
...
• **formType**: _[FormType](../modules/_ovl_src_library_forms_actions_.md#formtype)_

_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[formType](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#formtype)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[namespace](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#namespace)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[schema](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#schema)_

Defined in ovl/src/library/forms/OvlFormElement.ts:28

#### Type declaration:

- \[ **key**: _string_\]: [Schema](../modules/_ovl_src_library_forms_ovlformelement_.md#schema)
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[validationFnName](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#validationfnname)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[disconnectedCallback](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#disconnectedcallback)_
...
_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[doRender](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#dorender)_

_Overrides [OvlBaseElement](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md).[doRender](_ovl_src_library_ovlbaseelement_.ovlbaseelement.md#dorender)_
...
▸ **getFormFieldId**(`id`: string): _string_

_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[getFormFieldId](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#getformfieldid)_
...
_Defined in [test/src/screens/Feedback/FeedbackForm.ts:31](https://github.com/fopsdev/ovl/blob/f9b6194/test/src/screens/Feedback/FeedbackForm.ts#L31)_
...
▸ **handleOvlChange**(`e`: any): _Promise‹void›_

_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[handleOvlChange](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#handleovlchange)_
...
▸ **handleOvlFocusOut**(`e`: any): _Promise‹void›_

_Inherited from [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[handleOvlFocusOut](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#handleovlfocusout)_
...
_Overrides [OvlFormElement](_ovl_src_library_forms_ovlformelement_.ovlformelement.md).[init](_ovl_src_library_forms_ovlformelement_.ovlformelement.md#init)_

_Defined in [test/src/screens/Feedback/FeedbackForm.ts:25](https://github.com/fopsdev/ovl/blob/f9b6194/test/src/screens/Feedback/FeedbackForm.ts#L25)_
