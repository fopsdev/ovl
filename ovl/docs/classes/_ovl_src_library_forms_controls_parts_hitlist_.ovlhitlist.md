...
* [getUIAsync](_ovl_src_library_forms_controls_parts_hitlist_.ovlhitlist.md#getuiasync)
...
\+ **new OvlHitList**(): *[OvlHitList](_ovl_src_library_forms_controls_parts_hitlist_.ovlhitlist.md)*
